...
## Обновление контейнеров в модифицированной сборке

См. [CONTAINER-UPDATES-RU.md](CONTAINER-UPDATES-RU.md). Новые установки используют Panel 3.x, а меню управления поддерживает ручное и опциональное еженедельное обновление Panel, Subscription Page, reverse proxy и Node.
