...
2. The Beszel authorization page opens
    ...
    ![Admin creation](https://raw.githubusercontent.com/ivan-panov/remnawave-reverse/refs/heads/main/docs/src/assets/ru/beszel/admin_creation_beszel.png)

3. Enter your email address and a complex password to create an account

4. We enter the panel of Beszel

    ![Add System](https://raw.githubusercontent.com/ivan-panov/remnawave-reverse/refs/heads/main/docs/src/assets/ru/beszel/add_system_beszel.png)
...
2. Add your agent to the system
    ...
    ![Add System Host](https://raw.githubusercontent.com/ivan-panov/remnawave-reverse/refs/heads/main/docs/src/assets/ru/beszel/add_system_host_beszel.png)
...
7. We see that your agent is successfully installed
    ...
    ![Install Agent](https://raw.githubusercontent.com/ivan-panov/remnawave-reverse/refs/heads/main/docs/src/assets/ru/beszel/install_agent_beszel.png)
...
3. Wait a few minutes for the agent to connect to the Beszel panel. Port 45876 is used for agent communication with the Beszel Hub, so it should only be open for the Hub server IP address.
    ...
    ![Host System](https://raw.githubusercontent.com/ivan-panov/remnawave-reverse/refs/heads/main/docs/src/assets/ru/beszel/host_system_beszel.png)
...
3. Go to the `Settings` section 
    ...
    ![Beszel Settings](https://raw.githubusercontent.com/ivan-panov/remnawave-reverse/refs/heads/main/docs/src/assets/en/beszel/beszel_settings.png)

4. Click on `Notification`

    ![Beszel Notifications](https://raw.githubusercontent.com/ivan-panov/remnawave-reverse/refs/heads/main/docs/src/assets/en/beszel/beszel_notifications.png)
